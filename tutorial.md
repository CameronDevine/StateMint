...
The purpose of this tutorial is to give the necessary background information on how to use the StateMintum software to those who have some experience with system dynamics but may need a refresher, or are not familiar with the linear graph method.
...
An example continuing this tutorial is [provided](https://github.com/CameronDevine/StateMintum/blob/master/python/Example.ipynb).

### Mathematica

Finally, the Mathematica package can be used.
An example using Mathematica is also [provided](https://github.com/CameronDevine/StateMintum/blob/master/mathematica/Example.nb).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzEyMTE5NzddfQ==
-->